...
class Miners(Entity):
   def __init__(self, name, resource_limit, position,
                rate, imgs, animation_rate):
      super(Miners, self).__init__(name, imgs, position)
...
class Interactables(Entity):
   def __init__(self, name, rate, position, imgs, resource_distance):
      super(Interactables, self).__init__(name, imgs, position)
      self.rate = rate
...
class MinerNotFull(Miners, Pending):
...
class MinerFull(Miners, Pending):
...
class Vein(Interactables, Pending):
...
class Blacksmith(Interactables, Pending):
