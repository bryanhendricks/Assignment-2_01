...
class Viewport(object):
   def __init__(self, view_cols, view_rows, world):
      self.world = world
      self.num_rows = world.num_rows
      self.num_cols = world.num_cols
      self.viewport = pygame.Rect(0, 0, view_cols, view_rows)
...
class Drawing(Viewport):
   def __init__(self, view_cols, view_rows, screen, world, tile_width, tile_height):
      super(Drawing, self).__init__(view_cols, view_rows, world)
      self.screen = screen
      self.tile_width = tile_width
      self.tile_height = tile_height
...
#View
class View(Drawing):
   def __init__(self, view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None):
      super(View, self).__init__(view_cols, view_rows, screen, world, tile_width, tile_height)
      self.mouse_img = mouse_img
      self.mouse_pt = point.Point(0, 0)
...
class Tiles(Drawing):
   def __init__(self, view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None):
      super(Tiles, self).__init__(view_cols, view_rows, screen, world, tile_width, tile_height)
...
#Mouse
class Mouse(View, Tiles):
   def __init__(self, view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None):
      View.__init__(self, view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None)
      Tiles.__init__(self, view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None)
...
class WorldView(Mouse):
   def __init__(self, view_cols, view_rows, screen, world, tile_width,
      tile_height, mouse_img=None):
      super(WorldView, self).__init__(view_cols, view_rows, screen, world, tile_width, tile_height, mouse_img=None)
